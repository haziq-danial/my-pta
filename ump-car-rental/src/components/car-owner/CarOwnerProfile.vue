    ...
    <v-card flat>
        <v-container fluid grid-list-md>
            ...
            <v-layout row class="profile-height">
                ...
                <v-flex xs7>
                    <v-card-text>{{ car_owner.matric_no }}</v-card-text>
                </v-flex>
            </v-layout>
            <v-layout row class="profile-height">
                <v-flex xs2>
                ...
                <v-flex xs7>
                    <v-card-text>{{ car_owner.firstname }} {{ car_owner.lastname }}</v-card-text>
                </v-flex>
            </v-layout>
            <v-layout row class="profile-height">
                <v-flex xs2>
                ...
                <v-flex xs7>
                    <v-card-text>{{ car_owner.phone_no }}</v-card-text>
                </v-flex>
            </v-layout>
            <v-layout row class="profile-height">
                <v-flex xs2>
                ...
                <v-flex xs7>
                    <v-card-text>{{ car_owner.email }}</v-card-text>
                </v-flex>
            </v-layout>
            <v-layout row class="profile-height">
                <v-flex xs2>
            ...
            <v-layout row class="profile-height">
                ...
                <v-flex xs7>
                    <v-card-text>{{ car_owner.license_type }}</v-card-text>
                </v-flex>
            </v-layout>
            <v-layout row class="profile-height">
                <v-flex xs2>
                ...
                <v-flex xs7>
                    <v-card-text>{{ car_owner.license_expired }}</v-card-text>
                </v-flex>
            </v-layout>
            <v-layout row class="profile-height">
                <v-flex xs2>
                ...
                <v-flex xs7>
                    <v-card-text>{{ car_owner.student_country }}</v-card-text>
                </v-flex>
            </v-layout>
            <v-layout row class="profile-height">
                <v-flex xs2>
                ...
                <v-flex xs7>
                    <v-card-text>{{ car_owner.id_no }}</v-card-text>
                </v-flex>
            </v-layout>
        </v-container>
...
export default {
    ...
    computed: {
        ...
        age: function() {
            let dob = this.car_owner.date_of_birth || '2000-09-27'
            let date = new Date()
